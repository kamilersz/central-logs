...
> [API.md § OpenTelemetry](../API.md). No collector required.
...
|---|---|---|---|
| TypeScript/JS | [`js/central-logs.ts`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/js/central-logs.ts) | none (Node 18+/Bun) | `import { log } from "./central-logs.ts"` |
| Python | [`python/central_logs.py`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/python/central_logs.py) | stdlib only | `from central_logs import log` |
| Rust | [`rust/central_logs.rs`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/rust/central_logs.rs) | std only (raw HTTP/1.1) | `mod central_logs;` |
| PHP | [`php/central_logs.php`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/php/central_logs.php) | ext-curl (standard) | `require 'central_logs.php';` |
| Java | [`java/CentralLogs.java`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/java/CentralLogs.java) | JDK 11+ (`java.net.http`) | `new CentralLogs().log(...)` |
| C | [`c/central_logs.c`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/c/central_logs.c) | libcurl, pthread | `cc app.c central_logs.c -lcurl -lpthread` |
| C++ | [`cpp/central_logs.cpp`](https://github.com/kamilersz/central-logs/blob/main/integration-sample/cpp/central_logs.cpp) | libcurl, pthread | `g++ -std=c++17 app.cpp central_logs.cpp -lcurl -lpthread` |
